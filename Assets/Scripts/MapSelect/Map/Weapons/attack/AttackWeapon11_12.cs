...
public class AttackWeapon11_12: MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float MoveX = Chara.transform.position.x + cos * WeaponParn.range * WeaponParn.AddSpeed;
        float MoveY = Chara.position.y - 0.475f + sin * WeaponParn.range * WeaponParn.AddSpeed;
