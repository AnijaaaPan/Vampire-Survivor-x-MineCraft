...
public class Json : MonoBehaviour
{
    ...
    public PlayerData SaveAchievements(PlayerData player)
    {
        ...
        SaveFunction(42, "Skeletonを合計3000体倒す", "chara", 16);
        SaveFunction(43, "LionHeadを合計3000体倒す", "chara", 17);
        SaveFunction(44, "Milk Elementalsを合計3000体倒す", "chara", 18);
        SaveFunction(45, "Dragon Shrimpsを合計3000体倒す", "chara", 19);
        SaveFunction(46, "敵を合計5,000体倒す", "weapon", 21);
        SaveFunction(47, "敵を合計10,000体倒す", "chara", 10);
        SaveFunction(48, "狂乱の森に出現する25分ボスを撃破", "hyper", 1);
        SaveFunction(49, "象眼の図書館に出現する25分ボスを撃破", "hyper", 2);
        SaveFunction(50, "酪農場に出現する25分ボスを撃破", "hyper", 3);
        SaveFunction(51, "Gallo Towerに出現する25分ボスを撃破", "hyper", 4);
